...
export async function authenticateUser(req, res) {
  ...
  try {
    ...
    // console.log('reached log in controller');
    ...
    if (!user) {
      return res
        .status(400)
        .send('User does not exist. You may REGISTER user.');
    }
...
export async function addUser(req, res) {
  ...
  // console.log('Sequelize model table:', AuthUser.getTableName());
  ...
  try {
    ...
    const token = signToken(username);
    // console.log('right before sending cookie');
